...
| :------: | :------: | :------: | :----: |
|    userId    | 用户 ID  |    是    |   无   |
| password | 用户密码 |    是    |   大于等于 8 位, 小于等于 20 位, 不可以有空格   |
...
| :------: | :----: | :------: | :----: |
|   name   | 用户名 |    是    |   无   |
| password |  密码  |    是    |   大于等于 8 位, 小于等于 20 位, 不可以有空格 |
...
|  参数名  |  说明  | 是否必填 | 值规范 |
| :------: | :----: | :------: | :----: |
| oldPassword | 旧密码 |    是    |   大于等于 8 位, 小于等于 20 位, 不可以有空格 |
| newPassword | 新密码 |    是    |   大于等于 8 位, 小于等于 20 位, 不可以有空格 |
